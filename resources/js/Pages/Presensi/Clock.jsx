...
export const RealTimeClock = () => {
    ...
    return (
        <div className="relative bg-white grid grid-cols-2 border-x-2 border-primary m-2 p-4 rounded-lg xl:w-1/2 lg:-1/4 md:w-2/3 sm:w-1/2 w-full mx-auto items-center">
