...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('dokumens', function (Blueprint $table) {
            ...
            $table->dropColumn(['foto', 'waktu_foto', 'file_ktp', 'nik', 'npwp', 'file_npwp', 'bpjs', 'file_bpjs']);
            $table->integer('jenis_data_id')->after('karyawan_id');
            $table->text('file')->after('jenis_data_id');
    ...
    public function down(): void
    {
        Schema::table('dokumens', function (Blueprint $table) {
            ...
            $table->dropColumn(['jenis_data_id', 'file', 'no_identity']);
